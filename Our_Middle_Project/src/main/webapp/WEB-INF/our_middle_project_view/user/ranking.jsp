		...
		<div id="rankingMain">
			...
			<div id="centerMain">
				...
				<div id="centerWidth500">
					...
					<div id="rankingList-1">
						<!-- ezsy -->

						<div class="ranking-item ranking-header">
							<div class="ranking-column-main-1 ranking-columns">순위</div>
							<div class="ranking-column-main-2 ranking-columns">닉네임</div>
							<div class="ranking-column-main-3 ranking-columns">아이디</div>
							<div class="ranking-column-main-4 ranking-columns">콤보</div>
							<div class="ranking-column-main-5 ranking-columns">클리어시간</div>
							<div class="ranking-column-main-6 ranking-columns">최대점수</div>
						</div>

					</div>

					<div id="rankingList-2">
						<!-- normal -->
