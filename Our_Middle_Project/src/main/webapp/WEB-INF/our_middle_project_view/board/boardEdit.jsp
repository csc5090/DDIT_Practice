...
<body>
	...
	<div class="c_container">
		<div class="neon-text title">Board Edit</div>

		<form id="editForm"
			action="<%=request.getContextPath()%>/boardEdit.do?state=submit"
			method="post">
			...
			<div class="form-group">
				...
				<div style="display: flex; align-items: center; gap: 20px;">
					<span class="category-tag">[자유]</span> <input type="text"
						id="title" name="boardTitle" class="neon-input"
			...
			<div class="form-group">
				<label for="writer" class="neon-text-small">작성자</label> <input
					type="text" id="writer" name="memId" class="neon-input"
					value="${b.memId}" readonly>
			</div>

			<div class="form-group">
				<label for="content" class="neon-text-small">내용</label>
				<textarea id="content" name="boardContent" class="neon-textarea"
					required>${b.boardContent}</textarea>
			</div>

			<div class="write-actions">
				<button type="submit" class="neon-button edit-btn">수정 완료</button>
				<button type="button" class="neon-button cancel-btn"
					onclick="gogoBack()">취소</button>
			</div>
			<input type="hidden" name="boardNo" value="${b.boardNo}">
